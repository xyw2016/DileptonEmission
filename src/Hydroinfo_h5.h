...
private:
  ...
  double ***pi00, ***pi01, ***pi02, ***pi03, ***pi11, ***pi12, ***pi13, ***pi22,
      ***pi23, ***pi33;
  double ***BulkPi;
...
public:
  ...
  void setHydroFiles(int XL_in, int XH_in, double DX_in, int LSX_in, int YL_in,
                     int YH_in, double DY_in, int LSY_in, double Tau0_in,
                     double dTau_in, double LST_in, int Visflag_in,
                     string filename_in);
  ...
  void addGroupattributeDouble(hid_t H5groupEventid, string attName,
                               double attValue);
  void writeHydroBlock(int Time_id, double **ed_in, double **sd_in,
                       double **p_in, double **Temp_in, double **Vx_in,
                       double **Vy_in, double **Pi00_in, double **Pi01_in,
                       double **Pi02_in, double **Pi03_in, double **Pi11_in,
                       double **Pi12_in, double **Pi13_in, double **Pi22_in,
  ...
  double cubeInterpShell(int idx_x, int idx_y, int idx_z, double x, double y,
                         double z, double ***dataset);
  double cubeInterp(double x, double y, double z, double A000, double A100,
                    double A010, double A110, double A001, double A101,
