...
def generate_submit_jobs(script_dir, directory, walltime):
...
# Run the dilepton_emission.e program
./dilepton_emission.e
    """.format(working_folder, walltime)
...
if __name__ == '__main__':
    ...
    generate_submit_jobs(script_dir, dir_name, walltime)
